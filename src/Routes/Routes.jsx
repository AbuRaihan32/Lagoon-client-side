    ...
    children: [
      {
        ...
        element: <Home></Home>,
        loader: () =>
          fetch("https://10th-assignment-server-side-ten.vercel.app/allSpots"),
      },
      {
        path: "/details/:id",
        element: (
          <PrivateRouts>
            <HomeSpotsDetails></HomeSpotsDetails>
          </PrivateRouts>
        ),
        loader: ({ params }) =>
          fetch(
            `https://10th-assignment-server-side-ten.vercel.app/spot/${params.id}`
          ),
      },
      {
        path: "/add_spot",
