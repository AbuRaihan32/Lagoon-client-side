...
const Country = ({country}) => {
    ...
    return (
        <div>
            <div className="p-6 rounded-md shadow-md bg-gray-50 dark:bg-gray-50 text-gray-900 dark:text-gray-900">
                ...
                <p className="text-gray-900 dark:text-gray-800">{description.slice(0, 150)}...</p>
            </div>
        </div>
    );
};
