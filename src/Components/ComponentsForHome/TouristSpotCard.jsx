    ...
    return (
        <>
            <div data-aos="zoom-in"
                ...
                <figure><img className="h-[200px] w-full rounded-2xl" src={image} alt="spot-image" /></figure>
                <div className="card-body p-0 space-y-1">
                    <h2 className="gap-2 text-[18px] font-semibold mt-3">{tourists_spot_name}</h2>
                    <p><span className="text-[18px] font-semibold mt-3">Country Name:</span> {country_Name}</p>
                    ...
                    <ul className="ml-8 list-disc">
                        <li className="flex items-center gap-2"> <FaCircleChevronRight className="text-[#32CD32]"></FaCircleChevronRight>Average Cost : {average_cost} </li>
                        <li className="flex items-center gap-2"> <FaCircleChevronRight className="text-[#32CD32]"></FaCircleChevronRight>Seasonality : {seasonality}</li>
                        <li className="flex items-center gap-2"> <FaCircleChevronRight className="text-[#32CD32]"></FaCircleChevronRight>Travel Time : {travel_time}</li>
                    </ul>
                    ...
                    <div className="card-actions mx-auto mt-4">
                        <Link to={`/details/${_id}`} className="relative px-5 py-2 font-medium text-green-600 group">
