...
const Footer = () => {
    return (
        <footer style={{ backgroundImage: 'url(https://i.ibb.co/vVZJpGG/pexels-asadphoto-1591375.jpg)' }} className="rounded-t-3xl divide-y mt-20 bg-bottom bg-cover bg-no-repeat text-white ">
            <div className="bg-black bg-opacity-80 px-10 pt-12 pb-7 rounded-t-3xl">
                <div className="flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3 text-center">
                        ...
                        <a className="btn btn-ghost text-3xl font-bold">LaG <span className="text-3xl flex -mr-2 -ml-2 font-extrabold text-[#32CD32]"><RiEye2Line></RiEye2Line><RiEye2Line className="-ml-[2px]"></RiEye2Line></span> N</a>
                        <p>The Best Way To Find <br /> To Enjoy the Beauty of Nature</p>
                    </div>
                ...
                <div className="py-6 text-sm text-center">© 1968 lagoon. All rights reserved.</div>
            </div>
        </footer>
    );
};
