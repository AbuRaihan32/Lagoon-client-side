...
const Register = () => {
    ...
    const onSubmit = (data) => {
        const { FastName, LastName, email, password, image } = data;
    ...
    return (
        <>
            ...
            <div>
                <div className="min-w-screen min-h-screen flex items-center justify-center px-5 py-28">
                    <div className="bg-gray-100 text-gray-500 shadow-lg w-full overflow-hidden max-w-[1000px] mt-8" >
                                ...
                                <form className="" onSubmit={handleSubmit(onSubmit)} >
                                    <div className="flex gap-4">
                                        <div className="w-1/2 mb-5">
                                            ...
                                            <div className="flex flex-col">
                                                <input type="text" className="w-full py-2 pl-3 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John" {...register("FastName", { required: true })} />
                                                {errors.FastName && <span className="text-red-500 pl-3 font-bold">required</span>}
                                            </div>
                                        </div>
                                        <div className="w-1/2 mb-5">
                                            <label className="text-xs font-semibold px-1">Last name</label>
                                            <div className="flex">
                                                <input type="text" className="w-full pl-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Smith" {...register("LastName")} />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-5">
                                            ...
                                            <div className="flex flex-col">
                                                <input type="email" className="w-full pl-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com" {...register("email", { required: true })} />
                                                {errors.email && <span className="text-red-500 font-bold pl-3">This field is required</span>}
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-5">
                                            ...
                                            <div className="flex flex-col">
                                                <input type="text" className="w-full pl-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Photo URL" {...register("image")} />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-6">
                                            ...
                                            <div className="flex flex-col relative">
                                                <input type={show ? 'text' : 'password'} className="w-full pl-3 pt-2 pb-[6px] rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Enter your password" {...register("password", { required: true })} />

                                                <div onClick={() => setShow(!show)} className="absolute right-5 top-3 text-xl">
                                                    {
                                                        show ? <RiEyeCloseFill></RiEyeCloseFill> : <FaEye></FaEye>
                                                    }
                                                </div>
                                                <p className="text-red-600 font-bold">{error}</p>
                                                {errors.password && <span className="text-red-500 font-bold pl-3">This field is required</span>}
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center">
                                        <button className=" w-[70%] text-xl text-white relative px-5 py-2 font-semibold group">
                                            ...
                                            <span className="flex items-center justify-center gap-2 relative"><BiLogInCircle className="text-xl"></BiLogInCircle> <span className="hidden md:inline">Register</span> </span>
                                        </button>
                                    </div>
                                </form>
                                <p className="text-[16] mt-2 text-center sm:px-6 ">Already Have An Account?
