        ...
        <>
            ...
            <div >
                <div className="min-w-screen min-h-screen flex items-center justify-center px-5 py-28">
                    <div className="bg-gray-100 text-gray-700  shadow-lg w-full overflow-hidden max-w-[1000px] mt-8" >
                        <div className="md:flex w-full">
                            ...
                            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                                ...
                                <form className="" onSubmit={handleSubmit(onSubmit)} >
                                    ...
                                    <div className="flex justify-center">
                                        <button className=" w-[70%] text-xl text-white relative px-5 py-2 font-semibold group">
                                            ...
                                            <span className="flex items-center justify-center gap-2 relative"><BiLogInCircle className="text-xl"></BiLogInCircle> <span className="hidden md:inline">Sign In</span> </span>
                                        </button>
                                    </div>
                                </form>
                                ...
                                <p className="text-[16] mt-2 text-center sm:px-6 ">Do Not have an account?
