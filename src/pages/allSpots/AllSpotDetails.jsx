                ...
                <div className="min-w-screen min-h-screen pt-32 pb-24 bg-gray-900 bg-opacity-80 flex items-center justify-center px-5 rounded-b-3xl">
                    <div className="flex flex-col overflow-hidden rounded w-[95%] lg:w-[80%]">
                        <div className='h-[calc(100vh-30vh)] '>
                            <img src={image} alt="" className="w-full h-full object-cover bg-gray-500 rounded-3xl" />
                        </div>
                            ...
                            <div className="w-[90%] md:w-[85%] pb-12 m-4 mx-auto space-y-6  lg:rounded-md  card p-6 bg-base-100 shadow-xl border border-orange-600 bg-opacity-90">
                                <div className="space-y-2">
                                    <div className="py-5 flex flex-col md:flex-row justify-around">
                                        <h2 className="text-[21px] font-bold text-start"> Spot Name :{tourists_spot_name}</h2>
                                        <h2 className="text-[21px] font-bold text-start">Country Name : {country_Name}</h2>
                                    </div>


                                    <div className="text-center">
                                        <p> <span className="text-xl font-semibold">Average Cost : </span><span className="text-xl font-bold text-[#32CD32]">{average_cost} $</span></p>
                                    </div>
                                    ...
                                    <div className="md:flex justify-around mt-4">
                                        ...
                                        <p><span className='text-xl font-bold'>Travel Time :</span> <span className='text-xl'>{travel_time}</span></p>
                                    </div>

                                    <div className='md:flex justify-around'>
                                        <p className="text-xl font-bold">Seasonality : {seasonality}</p>
                                        <p className="text-xl font-bold">Total Visitor : {totalVisitorsPerYear}</p>
                                    </div>
                                    <div className=''>
